            ...
            <main className={styles.wrapper}>
                ...
                <div className={styles.hero__grid}>
                    ...
                    <div className={styles.hero__text}>
                        ...
                        >
                            <p>
                                Papersdrop, a place to learn, create and share
                            </p>
                        </div>
                ...
                >
                    ...
                    <div className={styles["hero__text"]}>
                        ...
                        <div className={styles["hero__subtitle"]}>
                            <p>
                                Papersdrop, a place to learn, create and share thoughts and voices of your own. A person
                                can create amazing content with just a splash of ink. We at Papersdrop want to serve as
                                a medium for you to write.
                            </p>
                            <p>
                                With us, your opinion matters and we provide you with various seo tools and features to
                                write beautiful and engaging content. With every drop of ink, we give you a platform to
