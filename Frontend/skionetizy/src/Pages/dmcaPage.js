  ...
  return (
    <>
      <div className={style.main}>
        ...
        <p>
          All the content on&nbsp;<strong>Papersdrop</strong>&nbsp;is either
          submitted to&nbsp;<a href="https://www.papersdrop.com/">Papersdrop</a>
          &nbsp;by email or is readily available in various places on the
          Internet and believed to be in the public domain. Content (including
          images and videos) posted are believed to be posted within our rights
          according to the U.S. Copyright Fair Use Act (Title 17, U.S. Code.)
        </p>
        <h3>Notification of Copyright Infringement</h3>
        <p>
          Papersdrop&nbsp;is in compliance with 17 U.S.C. &sect; 512 and the
          Digital Millennium Copyright Act (&ldquo;
          <a href="https://en.wikipedia.org/wiki/Digital_Millennium_Copyright_Act">
            DMCA
          </a>
          &rdquo;). It is our policy to respond to any infringement notices and
        ...
        <p>
          ...
          <a href="https://dmcagenerator.icu/">DMCA Generator</a>
        </p>
        <p>
          If your copyrighted material has been posted on Papersdrop or if links
          to your copyrighted material are returned through any search engine
          ...
          (including costs and attorneys&rsquo; fees) if you misrepresent
        ...
        <ul>
          ...
          <li>
            ...
            which the material appears in Papersdrop search results.
          </li>
          <li>
        ...
        <p>
          ...
          of an exclusive right that is allegedly being infringed.
        </p>
        <blockquote>
          <p>
            Please send the infringement notice via email
            to&nbsp;support@papersdrop.com
          </p>
        </blockquote>
        <p>
          Please allow us a day or two for an email response. Note that emailing
          ...
          due to the complaint not properly being filed. Thanks.
        </p>
        <h2>Contact information </h2>
        <p>
          {" "}
          If Have Any Issue with Papersdrop the we are always here to assist you
          on Email. The only way To contact us through email here is our email:
          support@papersdrop.com.
        </p>{" "}
        <h2>Additional information </h2>
        <p>
          Know more about our site by visiting this url:
          https://www.papersdrop.com/. We are operating from Telangana, India.
        </p>
      </div>
    </>
  );
