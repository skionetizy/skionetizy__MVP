...
export default function Privacy() {
  ...
  return (
    <div className={styles.privacy}>
      ...
      <p>
        At Papersdrop, accessible from https://www.papersdrop.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Papersdrop and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Papersdrop. This policy is not applicable to
      ...
      <p>
        Papersdrop follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of Papersdrop.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Papersdrop, which are sent
      ...
      <p>
        Note that Papersdrop has no access to or control over these cookies that
      ...
      <p>
        Papersdrop's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Papersdrop does not knowingly collect any Personal Identifiable
